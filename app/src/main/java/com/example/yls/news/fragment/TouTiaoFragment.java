...
public class TouTiaoFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_toutiao,null);
        initView(view);
        requestData();
        return view;
    }
    ...
    private void requestData() {
        ...
        final Request request=new Request.Builder().url("http://v.juhe.cn/toutiao/index?type=top&key=1953e0eee44fab207a57718d22cb479e").build();
